# Generated by Django 3.0.8 on 2021-03-11 08:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergencystatus', models.BooleanField(default=False, verbose_name='Emergency apply status')),
                ...
                ('alltimeofftype', models.CharField(choices=[('Sick Leave', 'Sick Leave'), ('Official Leave (In School)', 'Official Leave (In School)'), ('Official Leave (Outside)', 'Official Leave (Outside)'), ('Annual Leave', 'Annual Leave'), ('Casual Leave', 'Casual Leave'), ('Overtime', 'Overtime'), ('Overtime Compensatory Leave', 'Overtime Compensatory Leave'), ('Special Tuberculosis Leave', 'Special Tuberculosis Leave'), ('Maternal Leave', 'Maternal Leave'), ('No-Pay Leave', 'No-Pay Leave'), ('Paternity Leave', 'Paternity Leave'), ('Study Leave', 'Study Leave'), ('Jurors or Witnesses', 'Jurors or Witnesses'), ('Leave for Special Events', 'Leave for Special Events'), ('Others', 'Others')], default='Sick Leave', max_length=100, verbose_name='All Type of Leave')),
                ...
                ('nonteachertimeofftype', models.CharField(choices=[('Sick Leave', 'Sick Leave'), ('Official Leave (In School)', 'Official Leave (In School)'), ('Official Leave (Outside)', 'Official Leave (Outside)'), ('Annual Leave', 'Annual Leave'), ('Overtime', 'Overtime'), ('Overtime Compensatory Leave', 'Overtime Compensatory Leave'), ('Special Tuberculosis Leave', 'Special Tuberculosis Leave'), ('Maternal Leave', 'Maternal Leave'), ('No-Pay Leave', 'No-Pay Leave'), ('Paternity Leave', 'Paternity Leave'), ('Jurors or Witnesses', 'Jurors or Witnesses'), ('Others', 'Others')], default='Sick Leave', max_length=100, verbose_name='Type of Leave')),
                ('nonteacherchangetimeofftype', models.CharField(blank=True, choices=[('Annual Leave', 'Annual Leave'), ('Overtime Compensatory Leave', 'Overtime Compensatory Leave'), ('No-Pay Leave', 'No-Pay Leave')], max_length=100, null=True, verbose_name='Change Leave Type')),
                ('teacherchangetimeofftype', models.CharField(blank=True, choices=[('Casual Leave', 'Casual Leave'), ('No-Pay Leave', 'No-Pay Leave')], max_length=100, null=True, verbose_name='Change Leave Type')),
                ('startdate', models.DateField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 29700, tzinfo=utc))),
                ('starttime', models.TimeField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 29730, tzinfo=utc), null=True)),
                ('enddate', models.DateField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 29759, tzinfo=utc))),
                ('endtime', models.TimeField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 29788, tzinfo=utc), null=True)),
                ...
                ('firstapprovedby', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='firstapprovedby', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 33887, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firstday', models.DateField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 26326, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sickleavecounter', models.DecimalField(decimal_places=1, default=0, max_digits=60, verbose_name='Sick Leave Total')),
                ('casualleave', models.DecimalField(decimal_places=2, default=2, max_digits=3, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(20)], verbose_name='Casual Leave Balance')),
                ('firstday', models.DateField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 20796, tzinfo=utc))),
                ('increment', models.DecimalField(decimal_places=0, default=0, max_digits=2, verbose_name='Sick Leave Increment')),
                ('is_teacher', models.BooleanField(default=True, verbose_name='teacher status')),
                ('is_viceprincipal', models.BooleanField(default=False, verbose_name='Viceprincipal status')),
                ('is_principal', models.BooleanField(default=False, verbose_name='Principal status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firstday', models.DateField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 24141, tzinfo=utc))),
                ('increment', models.DecimalField(decimal_places=0, default=0, max_digits=2, verbose_name='Sick Leave Increment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratio', models.DecimalField(decimal_places=3, default=0, max_digits=4, verbose_name='Non-Teaching Ratio (100% nonteaching = 1)')),
                ('increment', models.DecimalField(decimal_places=0, default=0, max_digits=2, verbose_name='Sick Leave Increment')),
                ('firstday', models.DateField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 22920, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sickleave', models.DecimalField(decimal_places=1, default=0, max_digits=4, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(168)], verbose_name='Sick Leave Balance')),
                ('maxsickleave', models.DecimalField(decimal_places=1, default=128, max_digits=4, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(168)], verbose_name='Max. Sick Leave')),
                ('sickleavecounter', models.DecimalField(decimal_places=1, default=0, max_digits=60, verbose_name='Sick Leave Total')),
                ('annualleave', models.DecimalField(decimal_places=1, default=0, max_digits=4, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Annual Leave Balance')),
                ('maxannualleave', models.DecimalField(decimal_places=1, default=0, max_digits=4, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Max. Annual Leave')),
                ('compensatedleave', models.DecimalField(decimal_places=2, default=0, max_digits=4, verbose_name='Compensated Leave Available (Hours)')),
                ('ratio', models.DecimalField(decimal_places=3, default=0, max_digits=4, verbose_name='Non-Teaching Ratio (100% nonteaching = 1)')),
                ('increment', models.DecimalField(decimal_places=0, default=0, max_digits=2, verbose_name='Sick Leave Increment')),
                ('firstday', models.DateField(default=datetime.datetime(2021, 3, 11, 8, 46, 1, 21624, tzinfo=utc))),
                ('is_nonteacher', models.BooleanField(default=True, verbose_name='Non teaching staff status')),
                ('is_secretary', models.BooleanField(default=False, verbose_name='Secretary status')),
                ...
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='NonTeachingStaffDetail', to='customstaff.NonTeachingStaff')),
                ('viceprincipal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='viceprincipal', to='customstaff.VicePrincipal')),
            ],
        ),
    ]
